...
public class TranspathConstants {
    ...
    public static final String LIST_TAG_ID = "ID";
    public static final String BRANCH_TAG_1ST = "1st";
    public static final String BRANCH_TAG_2ND = "2nd";
    public static final String BRANCH_TAG_3RD = "3rd";
    public static final String BRANCH_TAG_4TH = "4th";    
}
